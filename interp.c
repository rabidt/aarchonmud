...
//    { "pipe",       do_pipe,    POS_DEAD,   ML,  LOG_ALWAYS, 1, FALSE, FALSE  },
    ...
    { "task",    do_task,   POS_DEAD,   L8,  LOG_NORMAL, 1, FALSE, FALSE  },
    { "whereis",    do_whereis, POS_DEAD,   L8,  LOG_NORMAL, 1, FALSE, FALSE  },
    { "lload",      do_lload,   POS_DEAD,   L8,  LOG_NORMAL, 1, FALSE, FALSE  },
{ "ltest",      do_ltest,   POS_DEAD,   L8,  LOG_NORMAL, 1, FALSE, FALSE  },
