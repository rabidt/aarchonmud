...
{
	/*sn			name			1st pers		3rd pers		color	color2	offbit				minlvl	check*/
	...
	{&sn_savantalk,	"Savantalk",	"savantalk",	"savantalks",	'7',	'8',	COMM_NOSAVANT,		0,		check_savant},
