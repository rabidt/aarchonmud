...
{ "se",         do_southeast,   POS_STANDING,  0,  LOG_NEVER, 0, FALSE, TRUE  },
    ...
    */
    ...
    { "cmotd",      do_cmotd,       POS_DEAD,    0,  LOG_NORMAL, 1, FALSE, TRUE  },
    { "[",          do_clantalk,    POS_DEAD,    0,  LOG_NORMAL, 0, FALSE, TRUE  },
    //{ "proclaim",   do_religion_talk, POS_SLEEPING,    0,  LOG_NORMAL, 1, FALSE, TRUE  },
    { "music",      do_music,       POS_DEAD,    0,  LOG_NORMAL, 1, FALSE, TRUE  },
    { "order",      do_order,   POS_RESTING,     0,  LOG_NORMAL, 1, FALSE, FALSE  },
    { "practice",   do_practice,    POS_RESTING,    0,  LOG_NORMAL, 1, FALSE, FALSE  },
    { "hpractice",  do_hpractice,   POS_RESTING,    0,  LOG_NORMAL, 1, FALSE, FALSE  },
...
//    { "powerthrust",do_power_thrust, POS_FIGHTING, 0, LOG_NORMAL, 1, FALSE, TRUE },
    ...
    { "rcast",      do_rcast,   POS_FIGHTING,    0,  LOG_NORMAL, 1, FALSE, TRUE  },
    ...
    */
    ...
    { "warstatus",  do_warstatus, POS_DEAD,      1,  LOG_NORMAL, 1, FALSE, FALSE },
    { "stopwar",    do_stopwar, POS_DEAD,       L8,  LOG_ALWAYS, 1, FALSE, FALSE },
    { "warsit",     do_warsit,  POS_DEAD,        1,  LOG_NORMAL, 1, FALSE, FALSE },
    ...
    */
    ...
    { "memory",     do_memory,  POS_DEAD,   L8,  LOG_NORMAL, 1, FALSE, FALSE  },
    { "version",    do_version, POS_DEAD,   L8,  LOG_NORMAL, 1, FALSE, FALSE  },
    { "perfmon",    do_perfmon, POS_DEAD,   L8,  LOG_NORMAL, 1, FALSE, FALSE  },
