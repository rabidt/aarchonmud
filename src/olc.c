...
char *olc_ed_name( CHAR_DATA *ch )
{
   ...
   case ED_MOBILE:
      ...
      break;
   case ED_MPCODE:
      snprintf( buf, sizeof(buf), "MPEdit" );
      break;
   case ED_OPCODE:
      snprintf( buf, sizeof(buf), "OPEdit" );
      break;
   case ED_APCODE:
      snprintf( buf, sizeof(buf), "APEdit" );
      break;
   case ED_RPCODE:
      snprintf( buf, sizeof(buf), "RPedit" );
      break;
   case ED_HELP:
...
char *olc_ed_vnum( CHAR_DATA *ch )
{
   ...
   case ED_APCODE:
      ...
      snprintf( buf, sizeof(buf), "%d", pAprog ? pAprog->vnum : 0 );
      break;
   case ED_RPCODE:
