...
const struct flag_type con_states [] =
{
    ...
    { "cb_handler",           CON_CB_HANDLER,           FALSE },
...
/*  type, limit, qps, exp, gold, obj, bit_vector, min_remort */
const ACHIEVEMENT achievement_table [] =
{
    { ACHV_LEVEL,       2,   2,   25,     5,     1,       0,    ACHIEVE_LEVEL_1, 0},
    { ACHV_LEVEL,      10,   3,   50,     5,     1,       0,    ACHIEVE_LEVEL_2, 0},
    { ACHV_LEVEL,      25,   5,  100,    50,     3,       0,    ACHIEVE_LEVEL_3, 0},
    { ACHV_LEVEL,      50,  10,  300,   250,     5,       0,    ACHIEVE_LEVEL_4, 0},
    { ACHV_LEVEL,      90,  25,    0,   500,    10,       0,    ACHIEVE_LEVEL_5, 0},
    { ACHV_LEVEL,      91,  30,    0,  1000,    15,       0,    ACHIEVE_LEVEL_6, 0},
    { ACHV_LEVEL,      92,  35,    0,  1500,    20,       0,    ACHIEVE_LEVEL_7, 0},
    { ACHV_LEVEL,      93,  40,    0,  2000,    25,       0,    ACHIEVE_LEVEL_8, 0},
    { ACHV_LEVEL,      94,  45,    0,  2500,    30,       0,    ACHIEVE_LEVEL_9, 0},
    { ACHV_LEVEL,      95,  50,    0,  3000,    35,       0,   ACHIEVE_LEVEL_10, 0},
    { ACHV_LEVEL,      96,  55,    0,  4000,    40,       0,   ACHIEVE_LEVEL_11, 0},
    { ACHV_LEVEL,      97,  60,    0,  5000,    45,       0,   ACHIEVE_LEVEL_12, 0},
    { ACHV_LEVEL,      98,  65,    0,  6000,    50,       0,   ACHIEVE_LEVEL_13, 0},
    { ACHV_LEVEL,      99,  70,    0,  7000,    50,       0,   ACHIEVE_LEVEL_14, 0},
    { ACHV_LEVEL,     100,  75,    0,  8000,   100,       0,   ACHIEVE_LEVEL_15, 0},
    /*                     570,  475, 40810,   430,      NA,               */
    /*      type,   limit, qps,  exp,  gold, achpoints, obj,    bit_vector */
    { ACHV_MKILL,       1,   1,   15,     5,     1,       0,    ACHIEVE_MKILL_1, 0},
    { ACHV_MKILL,      50,   2,   25,    10,     2,       0,    ACHIEVE_MKILL_2, 0},
    { ACHV_MKILL,     100,   3,   50,    50,     3,       0,    ACHIEVE_MKILL_3, 0},
    { ACHV_MKILL,     250,   5,   75,   150,     4,       0,    ACHIEVE_MKILL_4, 0},
    { ACHV_MKILL,     500,  10,  100,   250,     5,       0,    ACHIEVE_MKILL_5, 0},
    { ACHV_MKILL,    1000,  25,  150,  1000,    10,       0,    ACHIEVE_MKILL_6, 0},
    { ACHV_MKILL,    2500,  25,  300,  2500,    25,       0,    ACHIEVE_MKILL_7, 0},
    { ACHV_MKILL,    5000,  50,  450,  5000,    50,       0,    ACHIEVE_MKILL_8, 0},
    { ACHV_MKILL,   10000,  75,  700, 10000,    75,       0,    ACHIEVE_MKILL_9, 0},
    { ACHV_MKILL,   25000, 125, 1000, 25000,   150,       0,   ACHIEVE_MKILL_10, 0},
    { ACHV_MKILL,   50000, 250, 2500, 50000,   300,       0,   ACHIEVE_MKILL_11, 0},
    /*                     321, 5365, 93965,   625,      NA,               */
    /*      type,   limit, qps,  exp,  gold, achpoints, obj,    bit_vector */
    { ACHV_REMORT,      1,  10,  100,   250,    10,       0,   ACHIEVE_REMORT_1, 0},
    { ACHV_REMORT,      2,  15,  200,   500,    15,       0,   ACHIEVE_REMORT_2, 0},
    { ACHV_REMORT,      3,  20,  300,  1000,    20,       0,   ACHIEVE_REMORT_3, 0},
    { ACHV_REMORT,      4,  25,  400,  2000,    25,       0,   ACHIEVE_REMORT_4, 0},
    { ACHV_REMORT,      5,  30,  500,  4000,    30,       0,   ACHIEVE_REMORT_5, 0},
    { ACHV_REMORT,      6,  35,  600,  8000,    35,       0,   ACHIEVE_REMORT_6, 0},
    { ACHV_REMORT,      7,  40,  700, 10000,    40,       0,   ACHIEVE_REMORT_7, 0},
    { ACHV_REMORT,      8,  45,  800, 15000,    45,       0,   ACHIEVE_REMORT_8, 0},
    { ACHV_REMORT,      9,  50,  900, 20000,    50,       0,   ACHIEVE_REMORT_9, 0},
    { ACHV_REMORT,     10, 100, 1000, 25000,    55,       0,  ACHIEVE_REMORT_10, 0},
    /*                     640, 5500, 85750,   325,      NA,               */
    /*      type,   limit, qps,  exp,  gold, achpoints, obj,    bit_vector */
    { ACHV_QCOMP,       1,   5,   10,    10,     5,       0,    ACHIEVE_QCOMP_1, 0},
    { ACHV_QCOMP,      10,  15,   25,   100,    10,       0,    ACHIEVE_QCOMP_2, 0},
    { ACHV_QCOMP,      50,  20,  100,   500,    25,       0,    ACHIEVE_QCOMP_3, 0},
    { ACHV_QCOMP,     100,  25,  200,  1000,    50,       0,    ACHIEVE_QCOMP_4, 0},
    { ACHV_QCOMP,     250,  50,  500,  2500,    75,       0,    ACHIEVE_QCOMP_5, 0},
    { ACHV_QCOMP,     500, 100, 1000,  5000,   100,       0,    ACHIEVE_QCOMP_6, 0},
    { ACHV_QCOMP,     750, 150, 1500,  7500,   125,       0,    ACHIEVE_QCOMP_7, 0},
    { ACHV_QCOMP,    1000, 200, 2000, 10000,   150,       0,    ACHIEVE_QCOMP_8, 0},
    { ACHV_QCOMP,    2500, 300, 3000, 25000,   250,       0,    ACHIEVE_QCOMP_9, 0},
    { ACHV_QCOMP,    5000, 400, 5000, 50000,   500,       0,   ACHIEVE_QCOMP_10, 0},
    /*                    1265, 5365,101610,  1290,      NA,               */
    /*      type,   limit, qps,  exp,  gold, achpoints, obj,    bit_vector */	
    { ACHV_WKILL,       1,  10,   25,    25,     5,       0, ACHIEVE_WARKILLS_1, 0},
    { ACHV_WKILL,       5,  15,   50,    50,     5,       0, ACHIEVE_WARKILLS_2, 0},
    { ACHV_WKILL,      10,  20,   75,   250,    10,       0, ACHIEVE_WARKILLS_3, 0},
    { ACHV_WKILL,      25,  25,  100,  1000,    25,       0, ACHIEVE_WARKILLS_4, 0},
    { ACHV_WKILL,      50,  50,  150,  2500,    50,       0, ACHIEVE_WARKILLS_5, 0},
    { ACHV_WKILL,     100,  75,  300,  5000,   100,       0, ACHIEVE_WARKILLS_6, 0},
    { ACHV_WKILL,     250, 100,  500, 10000,   250,       0, ACHIEVE_WARKILLS_7, 0},
    { ACHV_WKILL,     500, 125, 1000, 20000,   500,       0, ACHIEVE_WARKILLS_8, 0},
    /*                     420, 2200, 33825,   945,      NA,               */
    /*      type,   limit, qps,  exp,  gold, achpoints, obj,    bit_vector */
    { ACHV_WWIN,        1,  10,   15,    25,     5,       0,  ACHIEVE_WARWINS_1, 0},
    { ACHV_WWIN,        5,  15,   15,    50,    10,       0,  ACHIEVE_WARWINS_2, 0},
    { ACHV_WWIN,       10,  20,   15,   250,    15,       0,  ACHIEVE_WARWINS_3, 0},
    { ACHV_WWIN,       25,  25,   15,  1000,    20,       0,  ACHIEVE_WARWINS_4, 0},
    { ACHV_WWIN,       50,  50,   15,  2500,    25,       0,  ACHIEVE_WARWINS_5, 0},
    { ACHV_WWIN,      100,  75,   15,  5000,    50,       0,  ACHIEVE_WARWINS_6, 0},
    { ACHV_WWIN,      250, 100,   15, 10000,   100,       0,  ACHIEVE_WARWINS_7, 0},
    { ACHV_WWIN,      500, 125,   15, 20000,   250,       0,  ACHIEVE_WARWINS_8, 0},
    /*                     420, 2200, 33825,   475,      NA,               */
    /*      type,   limit, qps,  exp,  gold, achpoints, obj,    bit_vector */
    { ACHV_BEHEAD,      1,   5,   25,    25,     5,       0,  ACHIEVE_BEHEADS_1, 0},
    { ACHV_BEHEAD,     10,  10,   50,    50,    10,       0,  ACHIEVE_BEHEADS_2, 0},
    { ACHV_BEHEAD,     25,  15,   75,   100,    15,       0,  ACHIEVE_BEHEADS_3, 0},
    { ACHV_BEHEAD,     50,  20,  100,   500,    20,       0,  ACHIEVE_BEHEADS_4, 0},
    { ACHV_BEHEAD,    100,  25,  250,  1000,    25,       0,  ACHIEVE_BEHEADS_5, 0},
    { ACHV_BEHEAD,    250,  50,  500,  2500,    50,       0,  ACHIEVE_BEHEADS_6, 0},
    { ACHV_BEHEAD,    500,  75, 1000,  5000,   100,       0,  ACHIEVE_BEHEADS_7, 0},
    { ACHV_BEHEAD,   1000, 100, 2000, 10000,   250,       0,  ACHIEVE_BEHEADS_8, 0},
    /*                     300, 4000, 19175,   475,      NA,               */
    /*      type,   limit, qps,  exp,  gold, achpoints, obj,    bit_vector */	
    { ACHV_PKILL,       1,  10,   50,   500,     5,       0,   ACHIEVE_PKILLS_1, 0},
    { ACHV_PKILL,      10,  25,  250,  1000,    25,       0,   ACHIEVE_PKILLS_2, 0},
    { ACHV_PKILL,      25,  50,  500,  2500,    50,       0,   ACHIEVE_PKILLS_3, 0},
    { ACHV_PKILL,      50, 100, 1000,  5000,   100,       0,   ACHIEVE_PKILLS_4, 0},
    { ACHV_PKILL,     100, 250, 2500, 10000,   250,       0,   ACHIEVE_PKILLS_5, 0},
    /*                     435, 4300, 19000,   430,      NA,               */
    /*      type,   limit, qps,  exp,  gold, achpoints, obj,    bit_vector */	
    { ACHV_AGE,        20,   5,   50,   250,     5,       0,      ACHIEVE_AGE_1, 0},
    { ACHV_AGE,        50,  10,   50,   500,     5,       0,      ACHIEVE_AGE_2, 0},
    { ACHV_AGE,       100,  25,   50,  1000,     5,       0,      ACHIEVE_AGE_3, 0},
    { ACHV_AGE,       250,  50,   50,  1500,    10,       0,      ACHIEVE_AGE_4, 0},
    { ACHV_AGE,       500,  50,   50,  3000,    25,       0,      ACHIEVE_AGE_5, 0},
    /*                     140,  250,  6750,    50,      NA,               */
    /*      type,   limit, qps,  exp,  gold, achpoints, obj,    bit_vector */
...
//  { ACHV_TATT,       13,   0,    0,     0,     0,       0,     ACHIEVE_TATT_3},
    /*                       0,    0,     0,     0,      NA,               */
    /*      type,   limit, qps,  exp,  gold, achpoints, obj,    bit_vector */
    { ACHV_MAXHP,     500,  10,   25,    50,     5,       0,    ACHIEVE_MAXHP_1, 0},
    { ACHV_MAXHP,    1000,  15,   50,   100,    10,       0,    ACHIEVE_MAXHP_2, 0},
    { ACHV_MAXHP,    5000,  20,  100,   500,    15,       0,    ACHIEVE_MAXHP_3, 0},
    { ACHV_MAXHP,   10000,  25,  150,  1000,    20,       0,    ACHIEVE_MAXHP_4, 0},
    { ACHV_MAXHP,   15000,  50,  300,  2500,    25,       0,    ACHIEVE_MAXHP_5, 0},
    /*                     120,  625,  4150,    75,      NA,               */
    /*      type,   limit, qps,  exp,  gold, achpoints, obj,    bit_vector */
    { ACHV_MAXMN,     500,  10,   25,    50,     5,       0,    ACHIEVE_MAXMN_1, 0},
    { ACHV_MAXMN,    1000,  15,   50,   100,    10,       0,    ACHIEVE_MAXMN_2, 0},
    { ACHV_MAXMN,    5000,  20,  100,   500,    15,       0,    ACHIEVE_MAXMN_3, 0},
    { ACHV_MAXMN,   10000,  25,  150,  1000,    20,       0,    ACHIEVE_MAXMN_4, 0},
    { ACHV_MAXMN,   15000,  50,  300,  2500,    25,       0,    ACHIEVE_MAXMN_5, 0},
    /*                     120,  625,  4150,    75,      NA,               */
    /*      type,   limit, qps,  exp,  gold, achpoints, obj,    bit_vector */
    { ACHV_MAXMV,     500,  10,   25,    50,     5,       0,    ACHIEVE_MAXMV_1, 0},
    { ACHV_MAXMV,    1000,  15,   50,   100,    10,       0,    ACHIEVE_MAXMV_2, 0},
    { ACHV_MAXMV,    5000,  20,  100,   500,    15,       0,    ACHIEVE_MAXMV_3, 0},
    { ACHV_MAXMV,   10000,  25,  150,  1000,    20,       0,    ACHIEVE_MAXMV_4, 0},
    /*                      70,  325,  1650,    25,      NA,               */
    /*      type,   limit, qps,  exp,  gold, achpoints, obj,    bit_vector */
    { ACHV_EXPLORED,   10,   5,   25,    25,     5,       0, ACHIEVE_EXPLORED_1, 0},
    { ACHV_EXPLORED,  100,   5,   50,    50,    10,       0, ACHIEVE_EXPLORED_2, 0},
    { ACHV_EXPLORED,  500,  10,  100,    75,    15,       0, ACHIEVE_EXPLORED_3, 0},
    { ACHV_EXPLORED, 1000,  25,  250,   100,    20,       0, ACHIEVE_EXPLORED_4, 0},
    { ACHV_EXPLORED, 2500,  50,  250,  1000,    25,       0, ACHIEVE_EXPLORED_5, 0},
    { ACHV_EXPLORED, 5000, 100,  250,  2500,    30,       0, ACHIEVE_EXPLORED_6, 0},
    { ACHV_EXPLORED,10000, 150,  500,  5000,    35,       0, ACHIEVE_EXPLORED_7, 0},
    { ACHV_EXPLORED,15000, 250, 1000, 10000,    50,       0, ACHIEVE_EXPLORED_8, 0},
    /*                     595, 2425, 18750,   190,      NA,               */
    /*      type,   limit, qps,  exp,  gold, achpoints, obj,    bit_vector */
    { ACHV_MASKILLS,    1,   5,   25,   100,     5,       0, ACHIEVE_MASKILLS_1, 1},
    { ACHV_MASKILLS,    3,  15,   75,   500,    10,       0, ACHIEVE_MASKILLS_2, 1},
    { ACHV_MASKILLS,    5,  25,  125,  1000,    15,       0, ACHIEVE_MASKILLS_3, 1},
    { ACHV_MASKILLS,   10,  50,  250,  2500,    20,       0, ACHIEVE_MASKILLS_4, 1},
    { ACHV_MASKILLS,   15,  75,  500,  5000,    25,       0, ACHIEVE_MASKILLS_5, 1},
    /*      type,   limit, qps,  exp,  gold, achpoints, obj,    bit_vector */
    { ACHV_GMSKILLS,    1,   5,   25,   100,     5,       0, ACHIEVE_GMSKILLS_1, 1},
    { ACHV_GMSKILLS,    3,  15,   75,   500,    10,       0, ACHIEVE_GMSKILLS_2, 1},
    { ACHV_GMSKILLS,    5,  25,  125,  1000,    15,       0, ACHIEVE_GMSKILLS_3, 1},
    { ACHV_GMSKILLS,   10,  50,  250,  2500,    20,       0, ACHIEVE_GMSKILLS_4, 1},
    { ACHV_GMSKILLS,   15,  75,  500,  5000,    25,       0, ACHIEVE_GMSKILLS_5, 1},
    /*      type,   limit, qps,  exp,  gold, achpoints, obj,    bit_vector */
    { ACHV_RETRAINED,   1,   5,   25,   100,     5,       0, ACHIEVE_RETRAINED_1, 1},
    { ACHV_RETRAINED,   3,  15,   75,   500,    10,       0, ACHIEVE_RETRAINED_2, 1},
    { ACHV_RETRAINED,   5,  25,  125,  1000,    15,       0, ACHIEVE_RETRAINED_3, 1},
    { ACHV_RETRAINED,  10,  50,  250,  2500,    20,       0, ACHIEVE_RETRAINED_4, 1},
    { ACHV_RETRAINED,  15,  75,  500,  5000,    25,       0, ACHIEVE_RETRAINED_5, 1},
    /*      type,   limit, qps,  exp,  gold, achpoints, obj,    bit_vector */
    { ACHV_QHCOMP,      1,   5,   25,   250,     5,       0,   ACHIEVE_QHCOMP_1, 0},
    { ACHV_QHCOMP,     10,  10,   50,   250,    10,       0,   ACHIEVE_QHCOMP_2, 0},
    { ACHV_QHCOMP,     50,  25,  100,   250,    25,       0,   ACHIEVE_QHCOMP_3, 0},
    { ACHV_QHCOMP,    100,  50,  250,   250,    50,       0,   ACHIEVE_QHCOMP_4, 0},
    { ACHV_QHCOMP,    250,  75,  500,   250,   100,       0,   ACHIEVE_QHCOMP_5, 0},
    { ACHV_QHCOMP,    500, 100,  750,   250,   250,       0,   ACHIEVE_QHCOMP_6, 0},
    /*      type,   limit, qps,  exp,  gold, achpoints, obj,    bit_vector */
    { ACHV_ASCENSION,   1, 250,   25, 25000,   100,       0, ACHIEVE_ASCENSION_1, 0},
    { ACHV_ASCENSION,   2, 500,   25, 50000,   200,       0, ACHIEVE_ASCENSION_2, 0},
    { ACHV_ASCENSION,   3, 750,   25, 75000,   300,       0, ACHIEVE_ASCENSION_3, 0},
	{ ACHV_ASCENSION,   4,1000,   25,100000,   400,       0, ACHIEVE_ASCENSION_4, 0},
	{ ACHV_ASCENSION,   5,1250,   25,125000,   500,       0, ACHIEVE_ASCENSION_5, 0},
	{ ACHV_ASCENSION,   6,1500,   25,150000,   600,       0, ACHIEVE_ASCENSION_6, 0},
	{ ACHV_ASCENSION,   7,1750,   25,175000,   700,       0, ACHIEVE_ASCENSION_7, 0},
    ...
    { ACHV_ASURVIVE,    1,   500,  0,  50000,  200,       0,  ACHIEVE_ASURVIVE_1, 0},
    { ACHV_ASURVIVE,    2,  1000,  0, 100000,  400,       0,  ACHIEVE_ASURVIVE_2, 0},
    { ACHV_ASURVIVE,    3,  1500,  0, 150000,  600,       0,  ACHIEVE_ASURVIVE_3, 0},
    { ACHV_ASURVIVE,    4,  2000,  0, 200000,  800,       0,  ACHIEVE_ASURVIVE_4, 0},
    { ACHV_ASURVIVE,    5,  2500,  0, 250000, 1000,       0,  ACHIEVE_ASURVIVE_5, 0},
    { ACHV_ASURVIVE,    6,  3000,  0, 300000, 1200,       0,  ACHIEVE_ASURVIVE_6, 0},
    { ACHV_ASURVIVE,    7,  3500,  0, 350000, 1400,       0,  ACHIEVE_ASURVIVE_7, 0},
    { ACHV_ASURVIVE,    8,  4000,  0, 400000, 1600,       0,  ACHIEVE_ASURVIVE_8, 0},
    { ACHV_ASURVIVE,    9,  4500,  0, 450000, 1800,       0,  ACHIEVE_ASURVIVE_9, 0},
    { ACHV_ASURVIVE,   10,  5000,  0, 500000, 2000,       0,  ACHIEVE_ASURVIVE_10, 0},
