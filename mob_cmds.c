 ...
 * Syntax: rpdump [vnum]
 */
void do_rpdump( CHAR_DATA *ch, const char *argument)
{
 ...
 * Syntax: apdump [vnum]
 */
void do_apdump( CHAR_DATA *ch, const char *argument)
{
   char buf[ MAX_INPUT_LENGTH ];
   char arg2[MIL];
   PROG_CODE *aprg;
 ...
 * Syntax: opdump [vnum]
 */
void do_opdump( CHAR_DATA *ch, const char *argument)
{
   char buf[ MAX_INPUT_LENGTH ];
   char arg2[MIL];
   PROG_CODE *oprg;
...
void do_mpremort( CHAR_DATA *ch, const char *argument)
{
    CHAR_DATA *victim;
    char arg[ MAX_INPUT_LENGTH ];
...
void do_mpqadvance( CHAR_DATA *ch, const char *argument)
{
    CHAR_DATA *victim;
    char arg[MAX_INPUT_LENGTH];
    char arg2[MIL];
...
void do_mprestore( CHAR_DATA *ch, const char *argument)
{
...
void do_mpact( CHAR_DATA *ch, const char *argument)
{
    int value;
    char arg1[MIL];
    bool not = FALSE;
...
void do_mphit( CHAR_DATA *ch, const char *argument)
{
    CHAR_DATA *victim;
