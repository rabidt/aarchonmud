...
void do_mmcast( CHAR_DATA *ch, const char *argument)
{
...
void do_ecast( CHAR_DATA *ch, const char *argument)
{
    meta_magic_cast(ch, "e", argument);
}

void do_pcast( CHAR_DATA *ch, const char *argument)
{
    meta_magic_cast(ch, "p", argument);
}

void do_qcast( CHAR_DATA *ch, const char *argument)
{
    meta_magic_cast(ch, "q", argument);
}

void do_ccast( CHAR_DATA *ch, const char *argument)
{
...
// Djinn wish casting
void do_wish( CHAR_DATA *ch, const char *argument)
{
    char arg1[MAX_INPUT_LENGTH];
    int sn, chance, class;
